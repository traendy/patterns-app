...
class StaticDesignPatternDataSource :DesignPatternDataSource {
    ...
    private val patterns = listOf(
        ...
        DesignPattern(
            ...
            structure = "chainofresponsibility"
        ),
        DesignPattern(
            id = 7,
            title = "Command",
    ...
    override suspend fun getDesignPatternById(id: Int):DesignPattern = patterns.firstOrNull{ it.id == id }?: nullDesignPattern

    override suspend fun getAllDesignPatterns():Collection<DesignPattern> = patterns
    ...
    override suspend fun saveDesignPattern(designPattern: DesignPattern) { // not implemented
    }
}